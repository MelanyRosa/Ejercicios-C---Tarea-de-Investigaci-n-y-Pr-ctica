...
int main() {
	...
	return 0;
	*/
	string frutas[9] = { "fresa", "sandia", "melon", "fresa", "naranja", "melon", "mango", "naranja", "fresa" }; // Se declara el arreglo de frutas
	int contador[4] = { 0, 0, 0, 0 }; // Se declara un array para contar cuántas veces aparece cada fruta
	int d; 
